...
### Screenshots
*Figure 4: user1 logs in.*


*Figure 5: user1 can access their own message.*


*Figure 6: user1 cannot access the messages of user2 or user3.*
...
### Screenshots
*Figures 7 and* *8* display user1 with `id=1` logging in, receiving the `access_token` and performing a request on their message. *Figure 9* demonstrates the error user1 receives upon attempting to retrieve another users' messages.
...
| Yasin Ughur         | Re-structuring the codebase, implementing the Unpredictable IDs protection, writing the report. |                                                                        |
